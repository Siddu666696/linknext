...
import hotjobimage from "../../public/assets/images/featureImages/hotJobImageIcon.png"
        ...
        <Grid>
          <Box
            sx={{
              ...
              boxShadow: "0px 4px 10px rgba(70, 65, 65, 0.1)", // Soft shadow
              borderRadius: "8px", // Optional: rounded corners
              // padding: 2,
            }}
          >
            <Box sx={{display:"flex", flexDirection:"row", height:80, bgcolor:"#e4eef5", gap:2,width: "970px",p:2}}>
              <Image src={hotjobimage} alt={"hot job"} width={40} height={40} />
              <Box sx={{display:"flex", flexDirection:"column",gap:1}}>
              <Typography fontSize={20} color="#395987" fontWeight={700}>Hot Job Listing</Typography>
              <Typography color="#395987">Post your job within 2 minutes and receive instant responses</Typography>
              </Box>
            </Box>
            ...
            >
              {qualificationData[selectedQualification].map((course) => (
                <MenuItem key={course} value={course}>
                  ...
                  <Divider sx={{ height: "1px", backgroundColor: "gray", my: 2 }}/>
                  <Grid item xs={12}>
                    <FormControlLabel

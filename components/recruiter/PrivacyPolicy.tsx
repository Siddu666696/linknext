...
//   const navigate = useNavigate();
  ...
  return (
    <div>
        <Box sx={{ mx:4, my:15,boxShadow: "0px 9px 18px rgba(69, 143, 246, 0.09)",
    ...
    <Box>
              ...
              <Box>
                ...
                >
                  <ul>
                    ...
                    <li>
                      <a href="#whatInformationWeCollectOnTheMedLinkWebsite">What Information We Collect on the MedLink Website and What We Do with It</a>
                    </li>
                    <li>
              ...
              <Box id="whatInformationWeCollectOnTheMedLinkWebsite" sx={{ pt: ((hashLink === "#whatInformationWeCollectOnTheMedLinkWebsite")) && "65px" }}>
                <Typography variant="subtitle1" sx={{ fontWeight: "600", textDecoration: "underline", py: 2, fontSize: "18px", color: "#395987" }}>
              ...
              <Box id="yourRight" sx={{ pt: ((hashLink === "#yourRight")) && "65px" }}>
                ...
                <Box>
                  ...
                  >
                    ...
                    {" "}<a
                      href="mailto: info@medlinkjobs.com"
                      style={{ color: "blue" }}
                      target="_blank"
                      rel="noreferrer"
                    >
